...
namespace APIEmpHub.Controllers
{
    ...
    public class ServiceRelationController : baseController<ServiceRelationModels>
    {
        ...
        {
            this._logger.LogInformation("ServiceRelation_Create [Request] : " + JsonSerializer.Serialize(iProp));
        ...
        {
            this._logger.LogInformation("ServiceRelation_Replace [Request] : " + JsonSerializer.Serialize(iProp));
        ...
        {
            this._logger.LogInformation("ServiceRelation_Delete [Request] : " + JsonSerializer.Serialize(iProp));
