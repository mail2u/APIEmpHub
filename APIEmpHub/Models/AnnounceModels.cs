...
{
    public class AnnounceModels : baseModels<AnnounceModels>
    {
        ...
        public void Create(AnnounceModels iProp)
        {
            String query = "up_announce_ins";
        ...
        public void Update(AnnounceModels iProp)
        {
            String query = "up_announce_upd";
        ...
        public void Delete(AnnounceModels iProp)
        {
            String query = "up_announce_del";
        ...
        public List<AnnounceModels> DataList(AnnounceModels iProp)
        {
            String query = "up_announce_sel";
            List<AnnounceModels> lData = new List<AnnounceModels>();
