...
{
    public class CandidateModels : baseModels<CandidateModels>
    {
        ...
        public void Create(CandidateModels iProp)
        {
            String query = "up_candidate_ins";
            ...
            try
            {
                ...
                iSql.SqlCom_ExecuteNonQuery(query, CommandType.StoredProcedure
                    ...
                    , iSql.SqlCom_Parameter("@candidateId", SqlDbType.NVarChar, 50, ParameterDirection.Output)
                    );

                iProp.candidateId = HelperConvert.ConvertToString(iSql.sqlCom.Parameters["@candidateId"].Value);
            }
            catch (Exception ex)
            {
        ...
        public void Update(CandidateModels iProp)
        {
            String query = "up_candidate_upd";
        ...
        public void Delete(CandidateModels iProp)
        {
            String query = "up_candidate_del";
        ...
        public List<CandidateModels> DataList(CandidateModels iProp)
        {
            String query = "up_candidate_sel";
        ...
        public CandidateModels Detail(CandidateModels iProp)
        {
            String query = "up_candidate_detail";
            iData = new CandidateModels();
